...
export function DomainSettings() {
    ...
    const [tenantData, setTenantData] = useState<{ id: string; subdomain: string; domain: string | null } | null>(null);
    ...
    const handleSaveDomain = async () => {
        ...
        try {
            ...
            const previousDomain = tenantData?.domain;
            setTenantData(prev => prev ? { ...prev, domain: domainToSave } : null);

            if (tenantData?.id && previousDomain !== domainToSave && tenantData.id !== '00000000-0000-0000-0000-000000000000') {
            ...
            toast.success('Domæne gemt. Afventer godkendelse.');
        } catch (error: any) {
                        ...
                        {tenantData?.domain && (
                            <div className="mt-2 space-y-1">
                                ...
                                <div className="flex items-center gap-2 text-xs text-amber-600">
                                    ...
                                    <span>Afventer godkendelse og tilkobling i Vercel</span>
                                </div>
                            </div>
                        )}
                    </div>
