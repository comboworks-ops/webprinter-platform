                        ...
                        <div className="grid min-h-full gap-6 px-4 py-5 lg:grid-cols-[minmax(0,1fr)_340px] lg:px-6">
                            <div className="space-y-6">
                                    ...
                                    <div className="grid gap-5 md:grid-cols-2">
                                        <div className="space-y-2">
                                            ...
                                            <Select value={formData.machine_id} onValueChange={(v) => setFormData({ ...formData, machine_id: v })}>
                                                <SelectTrigger className="h-12 rounded-md border-slate-200 bg-white shadow-none">
                                ...
                                <section className="rounded-md border border-slate-200 bg-white p-6 shadow-none">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <div className="relative">
                                                <NumberInput
                                                    ...
                                                    onValueChange={(value) => setFormData({ ...formData, default_bleed_mm: value })}
                                                    className="h-12 rounded-md border-slate-200 bg-white pr-16 shadow-none"
                                                />
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <div className="relative">
                                                <NumberInput
                                                    ...
                                                    onValueChange={(value) => setFormData({ ...formData, default_gap_mm: value })}
                                                    className="h-12 rounded-md border-slate-200 bg-white pr-16 shadow-none"
                                                />
                                                <span className="pointer-events-none absolute right-3 top-1/2 -translate-y-1/2 rounded-md bg-slate-100 px-2 py-1 text-xs font-semibold uppercase tracking-wide text-slate-500">
                                                    mm
                                    ...
                                    <div className="mt-5 rounded-md border border-emerald-200 bg-white/70 px-4 py-3">
                            ...
                            <aside className="space-y-5 lg:sticky lg:top-5">
                                <div className="rounded-md border border-slate-200 bg-white p-5 shadow-none">
                                    ...
                                    <div className="mt-4 space-y-4 text-sm">
                                        ...
                                        <div className="flex items-start gap-3 rounded-md border border-slate-200 bg-slate-50 p-4">
                                            <Droplets className="mt-0.5 h-4 w-4 text-slate-700" />
                                            <div>
                                            ...
                                            <button
                                                ...
                                                className={cn(
                                                    ...
                                                    previewPreset.id === preset.id
                                                        ? "border-violet-200 bg-slate-100 text-slate-700"
                                                        : "border-slate-200 bg-white text-slate-600 hover:border-violet-200 hover:text-slate-700"
                                                )}
                                            >
                                                {preset.shortLabel}
                                            </button>
                                ...
                                {selectedMachine ? (
                                    ...
                                    <div className="rounded-md border border-dashed border-slate-300 bg-white p-6 text-sm text-slate-500 shadow-none">
