            ...
            <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
              ...
              <div className="grid gap-2 text-right text-sm text-slate-500 sm:grid-cols-3">
                ...
                <div className="rounded-md border border-slate-200 bg-slate-50 px-4 py-3">
                  ...
                  <div className="mt-1 font-semibold text-slate-700">{normalizedPrice.toFixed(2)} kr</div>
                </div>
              </div>
            </div>
          </DialogHeader>
                ...
                <div className="rounded-md border border-slate-200 bg-white p-5 shadow-none">
                  ...
                  <div className="mt-4 space-y-4 text-sm">
                    ...
                    {formData.pricing_mode === "PER_SHEET" ? (
                      <>
                        <div className="rounded-md border border-slate-200 bg-slate-50 p-4">
                          <div className="text-[11px] uppercase tracking-[0.18em] text-slate-700">Arkformat</div>
                          ...
                          <div className="mt-1 text-xs text-slate-700">{sheetAreaM2.toFixed(3)} m² råareal</div>
                        </div>
                        <div className="rounded-md border border-slate-200 bg-slate-50 p-4">
                      ...
                      <div className="rounded-md border border-slate-200 bg-slate-50 p-4">
                        <div className="text-[11px] uppercase tracking-[0.18em] text-slate-700">m²-baseret indkøb</div>
