...
export function SubscriptionSettings() {
    ...
    const invoices = [
        { id: 'INV-2024-001', date: '2024-01-01', amount: 599, status: 'paid' },
        { id: 'INV-2023-012', date: '2023-12-01', amount: 599, status: 'paid' },
        { id: 'INV-2023-011', date: '2023-11-01', amount: 599, status: 'paid' },
    ];
                    ...
                    <div className="flex items-center justify-between p-4 bg-primary/5 rounded-lg border border-primary/20">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-muted-foreground">599 kr/måned</p>
                            </div>
                        </div>
                    ...
                    <div className="flex items-center justify-between p-4 border rounded-lg">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-muted-foreground">Udløber 12/25</p>
                            </div>
                        </div>
