...
export const SITE_PACKAGES: SitePackage[] = [
  ...
  },
  {
    ...
    seedLibraryItems: [
      { id: 'grommets', name: 'Øjer / Ringe', templateType: 'finish', description: 'Metaløjer hver 50 cm' },
      { id: 'hemming', name: 'Kantforsegling / Søm', templateType: 'finish', description: 'Svejst kant hele vejen rundt' },
      { id: 'pockets', name: 'Lommer', templateType: 'finish', description: 'Tunnellomme top/bund til keder' },
      { id: 'keder', name: 'Keder', templateType: 'finish', description: 'Keder til spændrammer' },
      ...
      { id: 'cutout-letters', name: 'Udskårne Bogstaver', templateType: 'product' },
  ...
  },
  {
    ...
    seedLibraryItems: [
      ...
      { id: 'finish-oeskner', name: 'Øskner', templateType: 'finish' },
      { id: 'finish-tunnel', name: 'Tunnelsøm', templateType: 'finish' },
  ...
  },
  {
    ...
    seedFormats: [
      ...
      { id: 'cut-foil-120x30', name: 'Udskåret folie 120x30 cm', widthMm: 1200, heightMm: 300 },
    ...
    seedLibraryItems: [
      ...
      { id: 'cut-foil', name: 'Udskåret folie', templateType: 'product' },
  ...
  },
  {
    ...
    seedFormats: [
      ...
      { id: 'a2-board', name: 'Læringstavle A2', widthMm: 420, heightMm: 594 },
      { id: 'a1-board', name: 'Læringstavle A1', widthMm: 594, heightMm: 841 },
      { id: 'a0-board', name: 'Læringstavle A0', widthMm: 841, heightMm: 1189 },
    ...
    seedLibraryItems: [
      ...
      { id: 'laeringstavler', name: 'Læringstavler', templateType: 'product' },
      { id: 'edutainment', name: 'Edutainment Spil', templateType: 'product' },
      { id: 'vaeggrafikker', name: 'Væggrafikker', templateType: 'product' },
      ...
      { id: 'material-magnet', name: 'Magnetisk stålplade', templateType: 'material' },
    ],
  },
  {
    id: 'snap-cherish',
    ...
    seedLibraryItems: [
      { id: 'photobook', name: 'Fotobøger', templateType: 'product' },
      { id: 'poster', name: 'Plakater', templateType: 'product' },
      { id: 'floor-sticker', name: 'Gulv-klistermærker', templateType: 'product' },
      ...
      { id: 'finish-waterproof', name: 'Vandtæt coating', templateType: 'finish' },
