// POD Tenant Remove
// Deletes an imported POD product and its related data
...
serve(async (req) => {
    ...
    try {
        ...
        // Remove product option groups created for this POD product
        const groupPrefix = `pod_${importRow.product_id}_`;
        ...
        console.error("POD Remove error:", error);
